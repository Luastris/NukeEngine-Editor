...
// NOTE (NukeEngine): IMGUI_API stripped from the class — TextEditor is compiled INTO
// the editor executable, which defines IMGUI_API=dllimport for the NukeImGui DLL.
class TextEditor
{
public:
	// ------------- Exposed API ------------- //
